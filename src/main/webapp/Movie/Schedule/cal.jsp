...
<tr>
    <td align="center" bgcolor="purple" style="font-weight:bold"><a href="./cal.jsp?y=<%=prevYear%>&m=<%=prevMonth%>">◁</a> <%=year%>년 <%=month+1%>월 <a href="./cal.jsp?y=<%=nextYear%>&m=<%=nextMonth%>">▷</a></td>
</tr>
<tr>
    <td>
