...
<body>
    <div class="body-wrap">
        <div class="member-wrap">
            <h1 class="gohome">
                <a href="#" title="메인 페이지로 이동"><img src="../img/megaboxlogo.png">MEGABOX : Life Theater</a> 
            </h1>
            <div class="col-wrap">
                ...
                <table class="board-form">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="outprint">
                            	<p class="outprint p">※ '생년월일 + 휴대폰번호로' 티켓 출력</p>
                            </td>
                        </tr>
                        <tr>
        ...
        <br>
        <div class="footer">
        <button type="button" class="button join" onclick="joinForm_check();">회원가입</button>
        </div>
