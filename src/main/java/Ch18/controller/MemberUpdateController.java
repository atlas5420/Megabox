...
public class MemberUpdateController implements Controller {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("---------------------------------");
		System.out.println("MemberUpdateController의 처리중");
		System.out.println("---------------------------------");
		...
		//유저ID를 포함한 정보를 /HTMLCSSJS/Ch18JSP/RESULT/memberUpdateOutput.jsp로 전달
		HttpUtil.forward(request, response, "/Ch18JSP/RESULT/memberUpdateOutput.jsp");
